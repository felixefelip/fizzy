...
class Cards::ClosuresController
  def render(target = nil, *rest)
    ...
    case target
    when :create then ERBCardsClosuresCreate.new(card: @card, page: @page, source_column: @source_column, was_in_stream: @was_in_stream).__rbs_infer__body
    when :destroy then ERBCardsClosuresDestroy.new(card: @card, page: @page).__rbs_infer__body
    end
    true
  end
