...
class JoinCodesController
  def render(target = nil, *rest)
    ...
    case target
    when :inactive then ERBJoinCodesInactive.new(join_code: @join_code, page_title: @page_title).__rbs_infer__body
    when :new then ERBJoinCodesNew.new(join_code: @join_code, page_title: @page_title).__rbs_infer__body
    end
    true
  end
