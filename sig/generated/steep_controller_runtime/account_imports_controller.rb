...
class Account::ImportsController
  def render(target = nil, *rest)
    @__rbs_infer__performed = true
    case target
    when :new then ERBAccountImportsNew.new.__rbs_infer__body
    when :show then ERBAccountImportsShow.new(import: @import).__rbs_infer__body
    end
    true
  end
