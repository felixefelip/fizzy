...
class Boards::PublicationsController
  def render(target = nil, *rest)
    ...
    case target
    when :create then ERBBoardsPublicationsCreate.new(board: @board).__rbs_infer__body
    when :destroy then ERBBoardsPublicationsDestroy.new(board: @board).__rbs_infer__body
    end
    true
  end
