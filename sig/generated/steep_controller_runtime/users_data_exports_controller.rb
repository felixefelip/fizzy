...
class Users::DataExportsController
  def render(target = nil, *rest)
    @__rbs_infer__performed = true
    case target
    when :show then ERBUsersDataExportsShow.new(export: @export, page_title: @page_title, user: @user).__rbs_infer__body
    end
    true
  end
  ...
  def __rbs_infer__run_create
    ...
    ensure_export_limit_not_exceeded
    return if performed?
