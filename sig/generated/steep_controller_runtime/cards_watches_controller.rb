...
class Cards::WatchesController
  def render(target = nil, *rest)
    ...
    case target
    when :create then ERBCardsWatchesCreate.new(card: @card).__rbs_infer__body
    when :destroy then ERBCardsWatchesDestroy.new(card: @card).__rbs_infer__body
    when :show then ERBCardsWatchesShow.new(card: @card).__rbs_infer__body
    end
    true
  end
